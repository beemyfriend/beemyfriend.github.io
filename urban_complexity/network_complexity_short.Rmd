...
```{r, echo = F, message = F, warning = F, out.height = '500px'}
knitr::include_graphics('./street_networks_gb.png')
```
...
```{r, echo = F, message = F, out.height='500px'}
...
set.seed(4321)
dc_g %>%
  igraph::remove.vertex.attribute(name = 'x') %>%
  igraph::remove.vertex.attribute(name = 'y') %>% 
  igraph::remove.edge.attribute(name = 'color') %>%
  plot(vertex.label = '', vertex.size = .1)
```
