...
## Updating our graph for deeper analysis {.smallest}
...
## Updated Graph Info Continued (last one :)
...
ego(g_directed, order = 2, nodes = 'Hansel', mode = 'in')
ego(g_directed, order = 3, nodes = 'Gretel', mode = 'out')
```